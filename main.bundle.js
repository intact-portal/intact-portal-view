...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_xml2js__ = __webpack_require__("./node_modules/xml2js/lib/xml2js.js");
...
let DatasetArchiveComponent = class DatasetArchiveComponent {
    ...
    requestDatasetArchive() {
        this.featureDatasetService.getFeaturedDataset().subscribe(response => {
            Object(__WEBPACK_IMPORTED_MODULE_3_xml2js__["parseString"])(response, (err, result) => {
...
const baseURL = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].ebi_base_url;
...
let FeaturedDatasetComponent = class FeaturedDatasetComponent {
    ...
    requestDOTM() {
        this.featureDatasetService.getFeaturedDataset().subscribe(response => {
            let t, pId, pA, pY;
            Object(__WEBPACK_IMPORTED_MODULE_4_xml2js__["parseString"])(response, function (err, result) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_catch__ = __webpack_require__("./node_modules/rxjs/_esm2015/add/operator/catch.js");
...
const intactDotmURL = __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].intact_dotm_url;
let FeatureDatasetService = class FeatureDatasetService {
    constructor(http, reporter) {
        this.http = http;
        this.reporter = reporter;
        this.API_URL = 'assets/data/dotm-1.1.xml';
    }
    getFeaturedDataset() {
...
FeatureDatasetService = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_5__shared_service_google_analytics_google_analytics_service__["a" /* GoogleAnalyticsService */]])
...
let InteractionsListComponent = class InteractionsListComponent {
    ...
    /** EVENT EMITTERS **/
    onInteractorSelectedChanged(interactor) {
        this.interactorChanged.emit(interactor);
    }
    onInteractionsSelectedChanged(interaction) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Q" /* Output */])(),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */])
], InteractionsListComponent.prototype, "interactionChanged", void 0);
__decorate([
                ...
                },
                {
                    ...
                    render: this.tableFactory.enlistWithButtons((d) => {
                        ...
                        return `<div class="tag-cell-container vertical-flex">
                          ...
                          href="${__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].ebi_base_url}${__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].context_path}/documentation/docs#interaction_scoring"
                ...
                },
                {
                    ...
                    render: function (data, type) {
                        ...
                        <a target="_blank" class="tag-cell detailsExpansionsCell"
                           href="${__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].ebi_base_url}${__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].context_path}/documentation/docs#expansion_method" >
                            ${data}
                        </a>
                      </div>`;
                        }
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Q" /* Output */])(),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */])
], InteractionsTableComponent.prototype, "interactionChanged", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Boolean)
...
InteractomesConstants.interactomes = [
    ...
    new __WEBPACK_IMPORTED_MODULE_0__interactome_model__["a" /* Interactome */]('Desulfovibrio vulgaris (strain Hildenborough / ATCC 29579 / NCIMB 8303)', 'L', 'desvh', 'desvh', 882),
];
...
module.exports = "<header id=\"masthead\" class=\"masthead\">\n  <div class=\"masthead-inner row expanded\"> <!-- expanded -->\n    <!-- local-title -->\n    <div class=\"columns medium-12 large-8\">\n      <a routerLink=\"/home\" title=\"Back to Intact homepage\">\n        <div class=\"media-object\" id=\"local-title\">\n          <div class=\"media-object-section\" >\n            <img src=\"assets/images/logo/intact_logo.svg\" alt=\"IntAct logo\" class=\"padding-left-large\" style=\"height:5em; width:21em;\">\n          </div>\n        </div>\n      </a>\n    </div>\n    <!-- /local-title -->\n\n    <!-- local-nav -->\n    <nav>\n      <ul id=\"local-nav\" class=\"dropdown menu float-left\" data-dropdown-menu=\"true\" data-description=\"navigational\">\n        <li routerLinkActive=\"active\"><a routerLink=\"/home\" routerLinkActive=\"active\">Home</a></li>\n        <li routerLinkActive=\"active\"><a routerLink=\"/download\" routerLinkActive=\"active\">Download</a></li>\n        <li routerLinkActive=\"active\"><a routerLink=\"/faq\" routerLinkActive=\"active\">FAQ</a></li>\n        <li routerLinkActive=\"active\"><a routerLink=\"/about\" routerLinkActive=\"active\">About</a></li>\n        <li class=\"extra-items-menu is-dropdown-submenu-parent opens-right\">\n          <a routerLinkActive=\"active\" routerLink=\"/documentation\">Documentation</a>\n          <ul class=\"menu submenu is-dropdown-submenu first-sub vertical\" role=\"menu\" >\n            <li class=\"no-border-submenu\" routerLinkActive=\"active\"><a routerLink=\"/documentation/user-guide\">User guide</a></li>\n            <li class=\"no-border-submenu\" routerLinkActive=\"active\"><a routerLink=\"/documentation/docs\">Docs</a></li>\n            <li routerLinkActive=\"active\"><a routerLink=\"/documentation/technical_corner\">Technical corner</a></li>\n          </ul>\n        </li>\n        <li routerLinkActive=\"active\"><a a style=\"background: crimson\" href=\"//www.ebi.ac.uk/support/intact\">Feedback <i class=\"icon icon-generic\" data-icon=\"x\"></i></a></li>\n      </ul>\n      <a routerLink=\"/home\" title=\"Back to Intact homepage\">\n        <div class=\"float-right\">\n          <img src=\"assets/images/logo/intact_icon_small.png\" alt=\"IntAct icon\" style=\"height:36px\">\n        </div>\n      </a>\n    </nav>\n    <!-- /local-nav -->\n  </div>\n</header>\n"
