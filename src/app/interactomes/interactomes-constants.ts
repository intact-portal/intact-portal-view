...
export abstract class InteractomesConstants {
  static readonly interactomes: Interactome[] = [
    new Interactome('Homo sapiens', 'H', 'human', 9606),
    new Interactome('Saccharomyces cerevisiae', 'Y', 'yeast', 559292),
    new Interactome('Drosophila melanogaster (Fruit fly)', 'F', 'drome', 7227),
    new Interactome('Caenorhabditis elegans', 'W', 'caeel', 6239),
    new Interactome('Arabidopsis thaliana (Mouse-ear cress)', 'B', 'arath', 3702),
    new Interactome('Mus musculus', 'M', 'mouse', 10090),
    new Interactome('Escherichia coli (strain K12)', 'L', 'ecoli', 83333),
    new Interactome('Campylobacter jejuni subsp. jejuni serotype O:2 (strain NCTC 11168)', 'L', 'camje', 192222),
    new Interactome('Rattus norvegicus (Rat)', 'R', 'rat', 10116),
    new Interactome('Treponema pallidum (strain Nichols)', 'L', 'trepa', 243276),
