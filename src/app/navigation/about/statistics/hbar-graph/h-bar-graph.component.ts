...
export class HBarGraphComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        d3.csv(this.dataPath, (row) => {
            ...
            const color: d3.ScaleOrdinal<any, any> = d3.scaleOrdinal()
                .domain(['H. sapiens', 'M. musculus', 'A. thaliana', 'R. norvegicus',
                    'C. elegans', 'D. melanogaster', 'S. cerevisiae', 'E. coli', 'Synechocystis sp.', 'C. jejuni', 'SARS-CoV-2'])
                .range(['rgb(51, 94, 148)', 'rgb(49, 51, 110)',
