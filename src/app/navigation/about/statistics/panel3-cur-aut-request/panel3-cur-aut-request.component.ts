...
@Component({
  selector: 'ip-panel3-cur-aut-request',
  templateUrl: './panel3-cur-aut-request.component.html',
  styleUrls: ['./panel3-cur-aut-request.component.css']
})
export class Panel3CurAutRequestComponent implements OnInit {
  @Input() data;
  ...
  ngAfterViewInit(): void {
    ...
    d3.csv('./assets/data-files/panel_3.csv', (row) => ({
      date: new Date(row.Date),
      'Curation Request': +row.CurationRequest,
      'Author Submitted': +row.AuthorSubmitted
